    ...
    try {
        switch ($_POST['action']) {
            case 'update_stock':
                ...
                if (executeQuery($updateSql, [$final_quantity, $inventory_id])) {
                    // Log transaction
            ...
            case 'add_to_inventory':
                ...
                if (executeQuery($sql, $params)) {
                    ...
                    echo json_encode(['success' => false, 'message' => 'Failed to add product to inventory']);
                }
                break;
            ...
            case 'update_inventory_settings':
                ...
                if (executeQuery($sql, $params)) {
                    ...
                    echo json_encode(['success' => false, 'message' => 'Failed to update inventory settings']);
                }
                break;
        }
    } catch (Exception $e) {
...
<body>
    ...
    <div class="modal fade" id="inventorySettingsModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
