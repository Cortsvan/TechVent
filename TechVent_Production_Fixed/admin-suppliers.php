        ...
        switch ($_POST['action']) {
            ...
            case 'delete_supplier':
                ...
                if ($productCount > 0) {
                    ...
                    executeQuery("DELETE FROM suppliers WHERE id = ?", [$id]);
...
<body>
    ...
    <!-- Edit Supplier Modal -->
    <div class="modal fade modal-custom" id="editSupplierModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                addForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        if (result.success) {
                            ...
                            if (modal) modal.hide();
                            // Give users time to see the success message
                        ...
                        AlertUtils.showError('An error occurred while adding the supplier: ' + error.message);
                    }
                });
            }
            ...
            if (editForm) {
                editForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        console.error('Error:', error);
                        AlertUtils.showError('An error occurred while updating the supplier: ' + error.message);
                    }
                });
            }
        }
